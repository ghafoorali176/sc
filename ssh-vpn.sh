...
xray="raw.githubusercontent.com/myridwan/sldns/ipuk"
...
#bahanvmess
wget -O menu-vmess "https://${xray}/menu-vmess.sh"
...
#bahanvless
wget -O menu-vless "https://${xray}/menu-vless.sh"
...
#bahantrojan
wget -O menu-trojan "https://${xray}/menu-trojan.sh"
